...
import * as ctrl from '../controllers/creditNotes.controller.js';
import { createCreditNoteSchema } from '../schemas/credit.schema.js';
...
router.post('/',    validateBody(createCreditNoteSchema), asyncHandler(ctrl.create));
