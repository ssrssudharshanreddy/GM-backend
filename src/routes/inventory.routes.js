...
import { adjustInventorySchema, updateThresholdSchema, listMovementsSchema, listInventorySchema } from '../schemas/inventory.schema.js';
...
router.get( '/',                 validateQuery(listInventorySchema), asyncHandler(ctrl.list));
...
router.get( '/:productId',        asyncHandler(ctrl.getByProduct));
router.post('/:productId/adjust', isWE, asyncHandler(ctrl.adjust));
